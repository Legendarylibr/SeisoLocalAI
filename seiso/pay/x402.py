...
# CAIP-2 network → USDC (6 decimals) used in PaymentRequired.asset
...
def x402_asset(network: str | None = None) -> str:
    ...
    if not asset:
        raise ValueError(f"no default USDC for network {net!r}; set SEISO_PAY_X402_ASSET=0x…")
    return asset
