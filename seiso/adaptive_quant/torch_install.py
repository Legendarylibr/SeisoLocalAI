...
def torch_cuda_ready_report() -> dict[str, object]:
    ...
    from seiso.adaptive_quant.hardware import nvidia_smi_visible, resolve_nvidia_smi_executable
    from seiso.adaptive_quant.torch_policy import torch_cuda_diagnostics
...
def probe_torch_policy_gradient_flow(*, device: str = "cpu") -> dict[str, object]:
    ...
    from seiso.adaptive_quant.torch_policy import TorchActorCritic, torch
...
def validate_cuda_after_install(
    ...
    *,
    ...
    from seiso.adaptive_quant.torch_policy import validate_cuda_runtime_compatibility
