...
from seiso.adaptive_quant.types import EpisodeResult, HardwareType, QuantizationDecision
...
class TrainerBase:
    ...
    def rollout(self, episodes: int) -> list[EpisodeResult]:
        return self._collect_episodes(episodes, episode_offset=2_000_000, phase="eval")
