...
from seiso.adaptive_quant.guardrails import passes_online_guardrails
...
from seiso.adaptive_quant.routing import EfficientTaskRouter
...
from seiso.adaptive_quant.types import OnlineRequest, PromptSample, QuantizationDecision, QuantMode
...
class OnlineLearningLoop:
    ...
    def serve_request(self, request: OnlineRequest) -> dict[str, Any]:
        ...
        from seiso.adaptive_quant.trainer_utils import feedback_vector
