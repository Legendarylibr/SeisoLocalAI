...
from seiso.adaptive_quant.checkpoint_integrity import attach_dict_integrity, verify_dict_integrity
...
class Trainer(TrainerBase):
    ...
    def _run_training_episode(self, episode_index: int) -> float:
        ...
        self.training_history.append(record_training_row(outcome))
...
def build_trainer(config: FrameworkConfig, log_path: str | None = None) -> Trainer:
    ...
    if config.training_backend == "pytorch":
        from seiso.adaptive_quant.torch_trainer import TorchTrainer
