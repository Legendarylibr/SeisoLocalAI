...
The route bandit treats every :class:`seiso.adaptive_quant.model_routes.ModelRoute` as an arm and
...
from seiso.adaptive_quant.features import COMPLEXITY_ROUTE_THRESHOLDS, complexity_bucket
from seiso.adaptive_quant.math_utils import argmax, finite_float, non_negative_int
