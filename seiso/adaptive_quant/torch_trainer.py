...
from seiso.adaptive_quant.base_trainer import TrainerBase, coerce_previous_action
from seiso.adaptive_quant.checkpoint_integrity import (
...
from seiso.adaptive_quant.trainer_utils import online_update_summary, reward_summary
    ...
    class TorchTrainer(TrainerBase):
        ...
        def _update_from_replay_or_batch(
            ...
            if (
                ...
                records = [record for record in replay_records if record is not None]
                if records:
                    return self._update_policy(records)
