...
from seiso.adaptive_quant.backend import (
    SimulatorBackend,
    require_llama_cpp_paths,
    run_llama_cpp_measurement,
)
from seiso.adaptive_quant.cli.common import add_config_file_argument, load_config_or_fallback
...
from seiso.adaptive_quant.math_utils import ratio_mean
from seiso.adaptive_quant.types import HardwareType, QuantizationDecision, QuantMode
...
def main(argv: Iterable[str] | None = None) -> None:
    ...
    from seiso.adaptive_quant.cli.common import enforce_cli_startup

    enforce_cli_startup(context="calibrate CLI")

    from seiso.adaptive_quant.presets.baseline import CONFIG as BASE
    ...
    from seiso.adaptive_quant.run_footer import print_calibration_footer
