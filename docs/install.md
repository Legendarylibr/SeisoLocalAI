...
First launch: open **http://127.0.0.1:8765**, **generate an npub** (or import an `nsec`), write down the shown npub, then Continue.
...
3. Complete onboarding — generate an npub (write it down → Continue) or import an `nsec`
