"""SQLite schema and column metadata for the Forge store."""
...
EXPORT_LIST_COLUMNS = ("id", "user_id", "status", "created_at", "updated_at")
...
UPSERT_MODEL_SQL = """INSERT INTO local_models
...
CONFIG_JOB_TABLES = frozenset({"rl_quant_jobs", "compress_jobs", "distill_rl_jobs"})
